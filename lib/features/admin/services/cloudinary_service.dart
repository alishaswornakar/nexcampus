  ...
  static Future<String?> uploadFile(File file) async {
    try {
      ...
      if (filePath.endsWith('.pdf') || filePath.endsWith('.doc') || filePath.endsWith('.docx')) {
        resourceType = 'raw'; // 👈 PDF र Docs को लागि 'raw' प्रयोग गर्दा शतप्रतिशत काम गर्छ
