...
class _AddStudentScreenState extends State<AddStudentScreen> {
  ...
  // Dropdown Selections (Section हटाइएको छ)
  String? _selectedDepartment;
  int? _selectedSemester;
  ...
  Future<void> _submitForm() async {
    if (_formKey.currentState!.validate()) {
      // Section को validation यहाँबाट हटाइएको छ
      ...
      try {
        final newStudent = StudentModel(
          id: '',
          name: _nameController.text.trim(),
          section: '', // खाली पठाउन सकिन्छ वा आवश्यक अनुसार
          rollNo: _rollController.text.trim(),
          email: _emailController.text.trim(),
          phone: _phoneController.text.trim(), // String.fromCharCode हटाइयो
          department: _selectedDepartment!,
          semester: _selectedSemester.toString(),
          address: _addressController.text.trim(),
          uid: '',
