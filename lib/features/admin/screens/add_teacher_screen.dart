...
class _AddTeacherScreenState extends State<AddTeacherScreen> {
  ...
  final TextEditingController _teacherIdController = TextEditingController(); // 👈 Teacher ID Controller
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: (val) =>
                    val == null || val.trim().isEmpty ? 'Enter teacher ID' : null,
              ),
              ...
              TextFormField(
                ...
                validator: (val) =>
                    val == null || val.trim().isEmpty ? 'Enter teacher name' : null,
              ),
              const SizedBox(height: 14),
              ...
              TextFormField(
                ...
                validator: (val) =>
                    val == null || val.trim().isEmpty ? 'Enter qualification' : null,
              ),
